...
export default function Home() {
    ...
    <main className="home">
      ...
      <section className="info">
        <h2>lorem ipsum</h2>
        <p>sed velit dignissim sodales ut eu sem integer vitae justo eget magna fermentum iaculis eu non diam phasellus vestibulum lorem sed risus ultricies tristique nulla</p>
        <div>
